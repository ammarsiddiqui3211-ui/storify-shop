...
💎 Premium Fashion Deal: Enjoy high-end minimalist design, a premium butterfly clasp, and sleek aesthetics for an unbeatable price of just 999 RS!', 850, 1200, 'Watches', 'watches', ARRAY['images/products/watches/Item 1/1.png'], ARRAY['#000000'], ARRAY['Fiber Strap', 'Steel Chain'], '{"Color/Theme":"Matte Jet Black (Full Monochromatic)","Dial Style":"Minimalist with unique Arabic numerals","Movement":"Precision Analog Quartz Movement","Strap Material":"Premium Lightweight Fiber / Stainless Steel Chain","Clasp Type":"Secure Butterfly Deployment Clasp","Gender":"Unisex (Designed for both Men & Women)","Fit":"Adjustable Link Strap for a standard, comfortable fit"}'::jsonb, NULL, true, 'available', 'linear-gradient(135deg, #1f2937 0%, #111827 100%)', true)
ON CONFLICT (id) DO UPDATE SET
  name = EXCLUDED.name, description = EXCLUDED.description, price = EXCLUDED.price, original_price = EXCLUDED.original_price, category = EXCLUDED.category, category_key = EXCLUDED.category_key, images = EXCLUDED.images, colors = EXCLUDED.colors, sizes = EXCLUDED.sizes, specs = EXCLUDED.specs, gradient = EXCLUDED.gradient, featured = EXCLUDED.featured;
...
💎 Premium Fashion Deal: Enjoy high-end minimalist design, a premium butterfly clasp, and pristine aesthetics for an unbeatable price of just 999 RS!', 850, 1200, 'Watches', 'watches', ARRAY['images/products/watches/Item 2/1.jpg'], ARRAY['#ffffff'], ARRAY['Fiber Strap', 'Steel Chain'], '{"Color/Theme":"Classic Frost White (Full Monochromatic Layout)","Dial Style":"Minimalist with subtle index markers / numeric layout","Movement":"Precision Analog Quartz Movement","Strap Material":"Premium Lightweight Fiber / Stainless Steel Chain","Clasp Type":"Secure Butterfly Deployment Clasp","Gender":"Unisex (Designed for both Men & Women)","Fit":"Adjustable Link Strap for a standard, comfortable fit"}'::jsonb, NULL, true, 'available', 'linear-gradient(135deg, #f3f4f6 0%, #e5e7eb 100%)', true)
ON CONFLICT (id) DO UPDATE SET
  name = EXCLUDED.name, description = EXCLUDED.description, price = EXCLUDED.price, original_price = EXCLUDED.original_price, category = EXCLUDED.category, category_key = EXCLUDED.category_key, images = EXCLUDED.images, colors = EXCLUDED.colors, sizes = EXCLUDED.sizes, specs = EXCLUDED.specs, gradient = EXCLUDED.gradient, featured = EXCLUDED.featured;
...
Premium Fashion Deal: Enjoy a premium automatic skeleton mechanical timepiece with an integrated faceted bracelet for an unbeatable price of just 3,000 RS!', 3000, NULL, 'Watches', 'watches', ARRAY['images/products/watches/Item 5/1.png'], ARRAY['#1e3a5f', '#f5f5f5'], ARRAY['Steel Chain'], '{"Color/Theme":"Royal Blue Ceramic / Arctic White Ceramic","Dial Style":"Skeleton / Transparent Mechanical Display","Movement":"Premium Automatic Mechanical Movement","Bracelet":"Integrated Matching Faceted Link Band","Clasp":"Secure Push-Button Deployment Clasp","Lens":"Scratch-Resistant Hardened Crystal","Case Back":"Transparent Exhibition View"}'::jsonb, NULL, true, 'available', 'linear-gradient(135deg, #1e3a5f 0%, #f5f5f5 100%)', true)
ON CONFLICT (id) DO UPDATE SET
  name = EXCLUDED.name, description = EXCLUDED.description, price = EXCLUDED.price, original_price = EXCLUDED.original_price, category = EXCLUDED.category, category_key = EXCLUDED.category_key, images = EXCLUDED.images, colors = EXCLUDED.colors, sizes = EXCLUDED.sizes, specs = EXCLUDED.specs, gradient = EXCLUDED.gradient, featured = EXCLUDED.featured;
